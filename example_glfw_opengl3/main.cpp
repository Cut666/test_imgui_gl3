...
#endif
    {
       ...
       /* if (show_demo_window)
        ...
        //    static int counter = 0;
            ...
            static char inputBuffer1[256] = ""; // Để lưu trữ giá trị nhập vào
            ImGui::SetNextItemWidth(-1.0f);
            ImGui::InputText("##InputText1", inputBuffer1, sizeof(inputBuffer1));
            // Ô nhập dữ liệu - Cột 2
            static char inputBuffer2[256] = ""; // Để lưu trữ giá trị nhập vào
            ...
            static char inputBuffernumber[256] = ""; // Để lưu trữ giá trị nhập vào
            ImGui::SetNextItemWidth(-1.0f);
            ...
            static char inputBufferSummary[256] = "";
            static char inputBufferUpload[256] = "";// Để lưu trữ giá trị nhập vào
            ImGui::SetNextItemWidth(-1.0f);
